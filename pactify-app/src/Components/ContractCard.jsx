    ...
    <div className="w-48 bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-2xl transition-shadow duration-300 relative">
      ...
      <div className="px-2 pb-2">
        <Link to={`/edit/${contract._id}`}>
          <h5 className="text-xl font-semibold tracking-tight hover:underline hover:decoration-red-500 text-gray-900">{contract.title}</h5>
        </Link>
          ...
          <div className="bg-pactifyPurple rounded-lg shadow-lg w-[28rem] ">
            ...
            <div className="p-4">
              <div className="grid grid-cols-2 gap-4">
                <button className=" flex justify-center bg-red-500 text-white py-2 rounded-full shadow-md hover:bg-red-700 self-center text-center transition duration-300 hover:scale-105" onClick={handleConfirm}>
                ...
                <button className=" bg-gray-500 text-white py-2 rounded-full shadow-md hover:bg-gray-700 self-center text-center transition duration-300 hover:scale-105" onClick={handleCancel}>
                  No, cancel
                </button>
              </div>
            </div>
